...
public class RegistrationUserDetailService implements UserService {
	...
	private static final Logger logger = LoggerFactory.getLogger(RegistrationUserDetailService.class);
	...
	public LocalUser registerNewUser(final UserRegistrationForm userRegistrationForm)
			throws UserAlreadyExistAuthenticationException {
		logger.info(null);

		com.spring.security.social.login.example.database.model.User userExist = userDAO
				.get(userRegistrationForm.getUserId());
		if (userExist != null) {
